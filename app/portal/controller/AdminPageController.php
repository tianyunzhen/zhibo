...
class AdminPageController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        if (!empty($data['photo_names']) && !empty($data['photo_urls'])) {
            ...
            foreach ($data['photo_urls'] as $key => $url) {
                ...
                array_push($data['post']['more']['photos'],
                    ["url" => $photoUrl, "name" => $data['photo_names'][$key]]);
            }
        }
        ...
        if (!empty($data['file_names']) && !empty($data['file_urls'])) {
            ...
            foreach ($data['file_urls'] as $key => $url) {
                ...
                array_push($data['post']['more']['files'],
                    ["url" => $fileUrl, "name" => $data['file_names'][$key]]);
            }
        }
        ...
        $this->success(lang('ADD_SUCCESS'),
            url('AdminPage/edit', ['id' => $portalPostModel->id]));
    ...
    public function edit()
    {
        ...
        $alias              = $routeModel->getUrl('portal/Page/index',
            ['id' => $id]);
