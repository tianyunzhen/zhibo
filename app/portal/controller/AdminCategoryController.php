...
class AdminCategoryController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if (empty($keyword)) {
            ...
            $categories = $portalCategoryModel->where('name', 'like',
                "%{$keyword}%")
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree
                             = $portalCategoryModel->adminCategoryTree($parentId);

        $themeModel = new ThemeModel();
        $listThemeFiles
                    = $themeModel->getActionThemeFiles('portal/List/index');
        $articleThemeFiles
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $categoriesTree
                = $portalCategoryModel->adminCategoryTree($category['parent_id'],
                $id);
            ...
            $alias      = $routeModel->getUrl('portal/List/index',
                ['id' => $id]);
...
tpl;
        ...
        $categoryTree
            = $portalCategoryModel->adminCategoryTableTree($selectedIds, $tpl);
    ...
    public function toggle()
    {
        ...
        if (isset($data['ids']) && !empty($data["display"])) {
            $portalCategoryModel->where('id', 'in', $ids)
                ->update(['status' => 1]);
            $this->success("更新成功！");
        }
    ...
    public function delete()
    {
        ...
        $categoryPostCount = Db::name('portal_category_post')
