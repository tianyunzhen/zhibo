...
class MusicController extends AdminbaseController
{
    ...
    function index()
    {
        ...
        $lists->each(function ($v, $k) {
            ...
            $v['uploader_nicename'] = Db::name("user")
                ->where(["id" => $v['uploader']])->value("user_nicename");
            return $v;
        });
    ...
    protected function upload()
    {
        ...
        if ($result === false) {
            return ["ret" => 0, 'file' => '', 'msg' => $uploader->getError()];
        }
