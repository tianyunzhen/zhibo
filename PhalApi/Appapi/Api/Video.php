...
class Api_Video extends PhalApi_Api
{
    ...
    public function getComments()
    {
        ...
        $domain        = new Domain_Video();
        $rs['info'][0] = $domain->getComments($this->uid, $this->videoid,
            $this->p);
    ...
    public function getReplys()
    {
        ...
        $domain     = new Domain_Video();
        $rs['info'] = $domain->getReplys($this->uid, $this->commentid,
            $this->p);
    ...
    public function setConversion()
    {
        ...
        $rs         = ['code' => 0, 'msg' => '视频完整观看次数更新成功', 'info' => []];
        $uid        = $this->uid;
        $videoid    = $this->videoid;
        $random_str = checkNull($this->random_str);
