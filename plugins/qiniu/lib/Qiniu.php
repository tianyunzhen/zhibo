...
class Qiniu
{
    ...
    public function __construct($config)
    {
        ...
        $this->storageRoot = $this->config['protocol'] . '://'
            . $this->config['domain'] . '/';
    }
    ...
    public function upload($file, $filePath, $fileType = 'image', $param = null)
    {
        ...
        $watermark = empty($this->config['styles_watermark']) ? 'watermark'
            : $this->config['styles_watermark'];
        ...
        $previewUrl = $fileType == 'image' ? $this->getPreviewUrl($file,
            $watermark) : $this->getFileDownloadUrl($file);
        $url        = $fileType == 'image' ? $this->getImageUrl($file,
            $watermark) : $this->getFileDownloadUrl($file);
