	...
	setThr: function(arr) {
		...
		for (var i = 0; i < len; i++) {
				...
				if(parseFloat(_temp.total)>0){
					_html+='<div class="'+classes[i]+'"><div class="stage">贡献<span class="ICON-coins">'+ _temp.total+'</span></div><div class="photo"><img src="/static/home/show/images/contribute'+(i+1)+'.png" class="rank_bg"><img src="'+_temp.userinfo.avatar+'" data-id="'+_temp.uid+'" class="rank_f_avatar"></div><p class="name" title="'+_temp.userinfo.user_nicename+'">'+_temp.userinfo.user_nicename+'</p></div>';
				}
