var Interface={
	...
	stopRoom:function()
	{
		var  msg = '{"retmsg":"ok","retcode":"000000","msg":[{"msgtype":"1","_method_":"stopRoom","ct":""}]}';
		Socket.emitData('broadcast',msg);
...
var liveType=
{
	getzombie_url:'/appapi/?service=Live.getZombie',
	checkLive_url:'/home/Show/checkLive',
	selectPlay_url:'/home/Show/selectPlay',
	//flash调用js弹出设置类型窗口
	Choice:function()
	{
		liveType.selectPlay(); 
	...
	roomCharge:function(liveuid,stream,type,isload){
		$.getJSON("/home/Spend/roomCharge", {liveuid:liveuid,stream:stream,type:type},
			function(data)
			{  
				if(data.code!=0)
				{
...
//房间管理操作
var Controls={
	cancel_url:'/home/Spend/cancel',
	gag_url:'/home/Spend/gag',
	tiren_url:'/home/Spend/tiren',
	black_url:'/home/Spend/black',
	stopRoom_url:'/appapi/?service=Live.superStopRoom',
	report_url:'/home/Spend/report',
...
var User={
	...
	userlistutl:'/home/show/getUserList',
	attionUrl:'/home/show/attention',
	popupInfo:'/home/show/popupInfo',
	minus_h:70,
	defnums:20,
	user_ismore:1,
	user_times:0,
			...
			$.ajax({
				...
				success:function(data){	
					...
					for(var i=0;i<len;i++){
						...
						html+='<img class="level" src="'+_DATA.level[userinfo.level]['thumb']+'">';
...
var Video={
	...
	vieoAreaMinW:853,
	videoMinH:533,
	endReUrl:'/home/show/endRecommend',
						...
						for(var i=0;i<len;i++){
							html+='<li>\
											<div class="rec-item">\
												...
												<img class="level" src="'+_DATA.level_anchor[data.data[i].userinfo.level_anchor]['thumb']+'">\
...
var Chat={
	...
	isfree:0,
	sendUrl:'/home/Spend/sendHorn',
	isShutUp:'/home/Spend/isShutUp',
	...
	setThr: function(arr) {
		...
		for (var i = 0; i < len; i++) {
				...
				if(parseFloat(_temp.total)>0){
					...
					_html+='<div class="'+classes[i]+'"><div class="stage">贡献<span class="ICON-coins">'+ _temp.total +'</span></div><div class="photo"><img src="/static/home/show/images/contribute'+(i+1)+'.png" class="rank_bg"><img src="'+_temp.userinfo.avatar+'" data-id="'+_temp.uid+'" class="rank_avatar"></div><p class="name" title="'+_temp.userinfo.user_nicename+'">'+_temp.userinfo.user_nicename+'</p></div>';
				}
