...
var Personal={
	...
	{
		$.getJSON("/home/Personal/follow_dal", {followID:followID},
		function(data) 
			{
				if(data["state"]==0)
				{
	...
	{
		$.getJSON("/home/Personal/follow_add",{touid:touid},
		function(data) 
			{
				if(data["state"]==0)
				{
	...
	{
		$.getJSON("/home/Personal/list_del",{touid:touid},
		function(data) 
			{
				if(data["state"]==0)
				{
	...
	exchange:function()
	{
		$.getJSON("/home/Personal/edit_exchange", {},
		function(data) 
			{
				 if(data['state']==0)
					{
	...
	photo:function()
	{
		...
		$.getJSON("/home/Personal/edit_photo", {avatar:avatar},
		function(data) 
			{
				if(data['error']==1)
				{
	...
	updatepass:function()
	{
		...
		if(newpass!=""&&repass!="")
		{
			$.getJSON("/home/Personal/savepass", {oldpass:oldpass,newpass:newpass,repass:repass},
			function(data) 
			{
				if(data["code"]==0)
				{
